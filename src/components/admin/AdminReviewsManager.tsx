...
export const AdminReviewsManager: React.FC<AdminReviewsManagerProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-[#181818] border border-[#2A2A2A] flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-xl">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#B89628] hover:from-[#E5C158] hover:to-[#D4AF37] text-[#111111] text-xs font-bold uppercase tracking-wider transition-all shadow-md flex items-center gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="px-3.5 py-2.5 rounded-xl bg-[#222222] hover:bg-[#2A2A2A] text-[#A0A0A0] hover:text-white border border-[#333333] text-xs font-semibold transition-all flex items-center gap-1.5 cursor-pointer"
      ...
      {showResetConfirm && (
        <div className="p-4 rounded-xl bg-red-950/90 border border-red-500/50 flex flex-col sm:flex-row items-center justify-between gap-3 animate-in fade-in">
          <div className="flex items-center gap-2.5 text-xs text-red-200">
            <AlertCircle className="w-5 h-5 text-red-400 shrink-0" />
            <span>
              <strong>Are you sure you want to reset all reviews?</strong> All custom reviews will be restored to default verified agency testimonials.
            </span>
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <button
              onClick={confirmResetDefaultsAction}
              className="px-3.5 py-1.5 rounded-lg bg-red-600 hover:bg-red-500 text-white font-bold text-xs uppercase tracking-wider cursor-pointer"
            >
              Yes, Reset All
            </button>
            <button
              onClick={() => setShowResetConfirm(false)}
              className="px-3.5 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-neutral-300 text-xs font-semibold cursor-pointer"
            >
              Cancel
            </button>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="pt-3 border-t border-[#2A2A2A] flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[11px] text-[#888888] truncate">
                        {rev.role},{" "}
                        <span className="text-[#BBBBBB] font-medium">{rev.company}</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-[#222222] hover:bg-[#2A2A2A] text-[#D4AF37] border border-[#333333] transition-colors cursor-pointer"
                      title="Edit Review"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg bg-[#222222] hover:bg-red-950/80 text-red-400 border border-[#333333] hover:border-red-800/60 transition-colors cursor-pointer"
                      title="Delete Review"
                    >
                ...
                {confirmDeleteId === rev.id && (
                  <div className="mt-3 p-3 rounded-xl bg-red-950/90 border border-red-500/60 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs animate-in fade-in">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-[#2A2A2A] mb-6">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-neutral-300 hover:text-white border border-white/10 text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
                >
            ...
            <form onSubmit={handleSaveModal} className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-[#111111] border border-[#2A2A2A] space-y-3">
                <DeviceImageUploader
                  ...
                  recommendedSizeText="Upload client portrait from your computer or phone (JPG, PNG, WebP up to 3MB)"
                  aspectRatioText="Square / Circular (1:1)"
                />

                {/* Quick Presets */}
                <div>
                  <div className="text-[11px] font-semibold text-[#888888] mb-1.5">
                    Or Choose Fast Stock Preset:
                  </div>
              ...
              <div className="flex items-center justify-between gap-3 pt-4 border-t border-[#2A2A2A]">
                <button
                  type="button"
                  onClick={handleCloseModal}
                  className="px-4 py-2.5 rounded-xl bg-[#222222] hover:bg-[#2A2A2A] text-[#A0A0A0] hover:text-white text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
                >
                  <X className="w-3.5 h-3.5" />
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#B89628] hover:from-[#E5C158] hover:to-[#D4AF37] text-[#111111] text-xs font-bold uppercase tracking-wider transition-all shadow-md flex items-center gap-2 cursor-pointer"
                >
