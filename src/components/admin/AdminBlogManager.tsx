          ...
          <div className="bg-white w-full max-w-4xl rounded-2xl border border-[#E8E1D0] shadow-2xl overflow-hidden my-8 max-h-[90vh] flex flex-col">
            ...
            <div className="px-6 py-4 bg-[#FAF9F5] border-b border-[#E8E1D0] flex items-center justify-between shrink-0">
              ...
              <button
                ...
                className="p-2 rounded-lg hover:bg-white text-[#777777] hover:text-[#111111] transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleSavePost} className="p-6 overflow-y-auto space-y-6 flex-1">
              <div className="grid lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-8 space-y-4">
                  ...
                  <div>
                    ...
                    {/* Image Presets */}
                    <div className="mt-2">
                      <span className="text-[10px] text-[#777777] font-semibold block mb-1">
                        Or select from high-resolution presets:
                      </span>
                        ...
                        {BLOG_IMAGE_PRESETS.map((preset, idx) => (
                          <button
                            ...
                            className={`text-[10px] px-2 py-0.5 rounded border transition-colors ${
                              imageUrl === preset.url
                                ? "bg-[#D4AF37] text-[#111111] font-bold border-[#D4AF37]"
              ...
              {/* Modal Footer */}
              <div className="pt-4 border-t border-[#E8E1D0] flex items-center justify-end gap-2.5">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-4 py-2 rounded-lg bg-white hover:bg-[#FAF9F5] border border-[#E8E1D0] text-xs font-semibold text-[#555555] transition-colors"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-5 py-2 rounded-lg bg-[#111111] hover:bg-black text-white border border-[#D4AF37] text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-sm transition-all"
                >
                  <CheckCircle2 className="w-4 h-4 text-[#D4AF37]" />
